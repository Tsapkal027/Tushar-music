...
OWNER_ID = int(getenv("OWNER_ID", 6711158464))
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/LITE_HELPER_CHAT")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/LITE_HELPER_CHAT")
